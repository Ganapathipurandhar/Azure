...
developer(need resources)--> jira ticket --> devops engineer --> create (resources)--> azure resource manager[ARM](it will create the resource)--> delivey to developer

Grouping by Project and Environment:

Large organizations: Separate Azure accounts for different environments. (DEV , stage, Prod)

Startups: Use Resource Groups for environment segregation (e.g., "Payments-Dev," "Payments-QA").
